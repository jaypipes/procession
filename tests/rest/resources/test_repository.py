...
class RepositoriesResourceTest(base.ResourceTestCase):

    def setUp(self):
        super(RepositoriesResourceTest, self).setUp()
        self.resource = repository.RepositoriesResource(self.conf)

    @mock.patch('procession.objects.Repository.get_many')
...
class RepositoryResourceTest(base.ResourceTestCase):

    def setUp(self):
        super(RepositoryResourceTest, self).setUp()
        self.resource = repository.RepositoryResource(self.conf)

    @mock.patch('procession.objects.Repository.get_by_slug_or_key')
