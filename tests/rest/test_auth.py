...
class TestApiAuth(base.UnitTest):
    ...
    def test_authentication(self):
        ...
        anon_ctx = mocks.AnonymousContextMock()
        auth_ctx = mocks.AuthenticatedContextMock()
        ...
        ctx = ContextToAuthenticate()
        req = FakeRequest(headers=headers)
        with mock.patch('procession.rest.auth.is_valid_token') as mocked:
